...
public class RegistrationPageTest extends BaseTest {
    ...
    public void verifyNewRegistrationClick() {
        ...
        registrationPage.enterFirstName("girish");
        registrationPage.enterLastName("sahni");
//        registrationPage.selectMaleGender();
        registrationPage.enterAgeYear("43");
        registrationPage.enterAgeMonth("0");
        registrationPage.enterNextOfKin("maya");
        registrationPage.enterContactNumber("6789098769");
